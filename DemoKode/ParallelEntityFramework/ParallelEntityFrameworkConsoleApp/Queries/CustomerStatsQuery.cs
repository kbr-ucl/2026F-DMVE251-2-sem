...
namespace ParallelEntityFrameworkConsoleApp.Queries;

public static class CustomerStatsQuery
{
    public static async Task<CustomerStatsDto> GetRandomCustomerStatsAsync(
